...
Tous les évènements sont stockés dans un fichier XML, comme suit :
<items>
  <item>
	<name>Petit Dejeuner</name>
	<period start="09h30m00s" end="10h30m00s" />
  </item>
  <item>
         ...
  </item>
...
void setup(){
  ...
  // on charge le XML contenant les informations d'emploi du temps
  liste_actions = new XMLElement(this, "emploiDuTemps.xml");
}
