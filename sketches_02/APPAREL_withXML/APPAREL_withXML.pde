...
void setup() {
  ...
  size(screenWidth/2, screenHeight-30, OPENGL);   // création de la fenêtre, et définition du mode de rendu; ici : OpenGL
  ...
  // Onglet "E_XML"
  init_XMLbyUser( "motiondesign_01" ); // chargement du XML à traiter
}
